...
<body>
	<div class="konghang"></div>
				...
				<div class="fl">
				<h2>${ins.aab102 }锟侥筹拷锟斤拷</h2>
				<!-- <span><i class="icon1"></i>2016-3-23 锟斤拷锟斤拷</span><br />-->
				<div class="guanzhuderen">
				<div class="x y">
				<span>锟斤拷注锟斤拷锟斤拷</span><br><a href="#"><span>${ins.aab107 }</span></a>
				</div>
				<div class="x">
				<span>锟斤拷锟斤拷注</span><br><a href="#"><span>${ins.aab108 }</span></a>
				</div>
				</div>

				</div>
				<div class="fr">
				<a href="#"><div class="guanzhu2">锟斤拷注</div></a>
				</div>
				</div>
		 ...
		 <div class="conwidth survey">
        	<div class="navigation">
        		<span class="bqcaipu"><a href="#" onclick="getRecipe('${param.aab101}')">锟斤拷锟斤拷</a></span>
        		<span class="bqzuopin"><a href="#" onclick="getWork('${param.aab101}')">锟斤拷品</a></span>
        		<span class="teshu bqshoucang"><a href="#" onclick="getCol('${param.aab101}')">锟秸诧拷</a></span>
        		<span class="bqliuyanban"><a href="#" onclick="getLike('${param.aab101}')">锟斤拷锟斤拷</a></span>
        	</div>
          ...
          <form id="myform" method="post">
        	...
        	<div class="userprod clearfix">
        		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
					<legend>锟斤拷锟斤拷</legend>
				</fieldset>
			         <!-- 锟斤拷示实锟绞诧拷询锟斤拷锟斤拷锟斤拷锟斤拷 -->
				     <c:forEach items="${reci}" var="ins" varStatus="vs">
		            		...
		            		<p>&nbsp;&nbsp;${ins.aac102}</p>
		        			<div class="stars">
		        				<a href="#" onclick="shanchu('${ins.aad201}','${ins.aac301}','${ins.aad203}')">删锟斤拷</a>
		        			</div>
				         </div>
				      </c:forEach>
			  </div>
