...
<html>
	...
	<body>
		<div class="header"><!--------------头部---------------->
		 ...
		 <div class="kh30"></div>
		 <input type="text" name="title" required lay-verify="required" placeholder="添加菜谱名称" autocomplete="off" class="layui-input">
		 ...
		 <div class="kh30"></div>
	     <div class="desc">
		 <textarea name="" required lay-verify="required" placeholder="添加菜谱描述" class="layui-textarea"></textarea>
		 </div>
          ...
          <tbody id="ings">
	    	   	  <tr>
				    <td><input type="text" style="width:100%; height:35px;border:0px;"></td>
				    <td><input type="text" style="width:100%; height:35px;border:0px;"></td>
				    <td>
				    <a class="layui-btn layui-btn-danger" onclick="delecttr(this)">删除</a>
			        </td>
				  </tr>
		  </tbody>
          </table>
          <input class="layui-btn" type="button" value="追加一行" onclick="addings()">
          </div>
		  
		  <div class="title"><h2 class="fubiaoti">做法</h2></div>
		  <div class="kh30"></div>
		  <div id="zuofa">
		  <div class="layui-row">
          <div class="layui-col-md1">1</div>
          <div class="layui-col-md3">
          <textarea rows="5" cols="20" placeholder="添加菜谱描述" style="width:100%;border:0px;height:240px"></textarea>
          </div>
          <div class="layui-col-md5">
          <img src="img/menubook/1.jpg" width="400px" height="270px">
          </div>
          <div class="layui-col-md2">
          <br><br><br><br><br>&nbsp;&nbsp;<a class="layui-btn layui-btn-danger" onclick="delecttr(this)">删除</a>
          </div>
          </div>
          ...
          <input class="layui-btn" type="button" value="追加一步" onclick="addzuofa('zuofa')">
          
          <div class="kh30"></div>
          
          <div class="layui-row">
          <div class="layui-col-md4 layui-col-md-offset3">
          <input class="layui-btn" type="button" value="发布菜谱" style="width:300px;height:50px;"></div>
          </div>
