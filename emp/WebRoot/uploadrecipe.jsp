...
function addzuofa()
{
    ...
    +"<div class='layui-col-md3'><textarea rows='5' cols='20' placeholder='添加步骤描述' style='width:100%;border:0px;height:240px' name='"+b+"aac402'></textarea></div>"
	...
	<div id="zuofa">
		...
		<div class="layui-row">
			...
			<div class="layui-col-md3">
				<textarea rows="5" cols="20" placeholder="添加步骤描述"
