		...
		success:function(data){
			...
			{	
				html+='<div class="layui-card">'
					 ...
					 +'</div>'
					 +'<div class="layui-col-md5">'
					 +'<a onclick="kitchen('+data.rows[i].aab101+')" style="cursor:pointer;">'+data.rows[i].aab102+'</a>'
		...
		success:function(data){
			...
			{	
				html+='<div class="layui-card">'
					 ...
					 +'<a onclick="toMenuDetail('+data.rows[i].aac101+')" style="cursor:pointer;"><img class="layui-nav-img" src="'+data.rows[i].aac108+'" style="width:100px;height: 80px;border:1px"></a>'
					 +'</div>'
					 +'<div class="layui-col-md5">'
					 +'<a onclick="kitchen('+data.rows[i].aab101+')" style="cursor:pointer;">'+data.rows[i].aac102+'</a><span>'
					 +'<p><span>'+data.rows[i].aab102+'&nbsp;创建</span><span>'+data.rows[i].aac110+'收藏</span></p>'
					 +'<a onclick="toMenuDetail('+data.rows[i].aac101+')" style="cursor:pointer;">'
					 +'更多细节...'
					 +'</a>'
					 +'</div>'
					 +'</div>'
